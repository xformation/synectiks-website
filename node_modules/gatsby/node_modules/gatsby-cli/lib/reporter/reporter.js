...
class Reporter {
  constructor() {
    ...
    (0, _defineProperty2.default)(this, "error", (errorMeta, error) => {
      ...
      if (structuredError) {
        _actions.default.createLog(structuredError);
    ...
    (0, _defineProperty2.default)(this, "verbose", text => {
      if (isVerbose) {
        _actions.default.createLog({
          level: _constants.LogLevels.Debug,
          text
        });
      }
    });
    (0, _defineProperty2.default)(this, "success", text => _actions.default.createLog({
      level: _constants.LogLevels.Success,
      text
    }));
    (0, _defineProperty2.default)(this, "info", text => _actions.default.createLog({
      level: _constants.LogLevels.Info,
      text
    }));
    (0, _defineProperty2.default)(this, "warn", text => _actions.default.createLog({
      level: _constants.LogLevels.Warning,
      text
    }));
    (0, _defineProperty2.default)(this, "log", text => _actions.default.createLog({
      level: _constants.LogLevels.Log,
      text
    }));
    (0, _defineProperty2.default)(this, "pendingActivity", _actions.default.createPendingActivity);
