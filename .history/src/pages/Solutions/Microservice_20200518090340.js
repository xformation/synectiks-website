                    ...
                    <div className="my-0 my-md-4	">
                      ...
                      <div className="mt-2 mt-md-4">
                        ...
                        <p className="ptext">
                          ...
                          become 100 small x. If you deploy those 100 x as
                          layered stack in discrete servers in different way,
                          ...
                          delivered in the same way and they are staged to
                          ...
                          Containers along with Continuous Delivery channel
                      ...
                      <div className="d-flex flex-column align-items-start flex-md-row justify-md-between  px-2 px-md-0 mt-2 mt-md-5">
                        <div className="pr-0 pr-md-5 w-100">
                          <h3 className="my-0 mb-md-2	mt-md-n3">
                  ...
                  <TabPane tabId="4">
                    <div>
                      ...
                      <img
                        ...
                        className="my-0 mt-md-4 microIm imgshadow"
                      />
                    </div>
                    <div>
                        ...
                        <div>
                          ...
                          <ul>
                            <li>
                              ...
                              don’t yield results. We recommend taking bottom up
                              approach, take a small piece of functionality, and
                              develop the services and foundation for it rapidly
                              by using existing application blocks and
                              ...
                              contribution helps us to deliver values vary
                              rapidly.
                            </li>
                            <li>
