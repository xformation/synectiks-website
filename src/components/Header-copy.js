        ...
        <nav>
          ...
          <div className="flex">
            ...
            <div className="menubar">
              ...
              <div class="dropdown">
                ...
                <div>
                  <div class="dropdown-content">
                    <a href="/synectiks-hosted-infrastructure-business-continuity/index.html">Hosted Infrastructure & Business Continuity<GoTriangleLeft className="icon-fnt ml-2 h5 mt-2" /></a>
                    <a className="p-2" href="/aws-managed-services/index.html">AWS Managed Services</a>
                  ...
                  <div class="dropdown-content">
                    <a className="main-sub-menu pl-2 py-0 lt-colr d-flex justify-content-between align-items-center"
                      href="/business-continuity-cyber-security/index.html"
                    >
                      Business Continuity & Cyber Security
                      <GoTriangleLeft className="icon-fnt ml-2 h5 mt-2" /></a>
                    <a className="main-sub-menu p-2"
              ...
              <div class="dropdown">
                <button class="dropbtn">MIGRATION & MODERNIZATION</button>
                <div class="dropdown-content">
                  <a href="#">Link 1</a>
                  <a href="#">Link 2</a>
                  <a href="#">Link 3</a>
